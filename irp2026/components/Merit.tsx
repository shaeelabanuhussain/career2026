      ...
      <div className="max-w-[1200px] mx-auto px-[clamp(20px,5vw,64px)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-[900px] mx-auto mb-8">
          <div className="reveal-scale d1 glow-green rounded-2xl border-2 border-green/30 bg-green/[0.06] p-10 text-center relative overflow-hidden border-glow">
            ...
            <p className="font-mono text-[0.6875rem] text-green tracking-[0.12em] uppercase mb-3">Top 10%</p>
            <p className="count-up text-[2.75rem] font-bold text-white tracking-[-0.03em] leading-none mb-2">100%</p>
            <p className="text-[0.9375rem] text-white/65">fee waiver</p>
            <p className="text-[0.8125rem] text-white/40 mt-4">Full waiver on remaining monthly fees</p>
          </div>
          <div className="reveal-scale d2 rounded-2xl border border-white/10 bg-white/[0.03] p-10 text-center border-glow">
            <p className="font-mono text-[0.6875rem] text-blue tracking-[0.12em] uppercase mb-3">Top 25%</p>
            <p className="count-up text-[2.75rem] font-bold text-white tracking-[-0.03em] leading-none mb-2">50%</p>
            <p className="text-[0.9375rem] text-white/65">fee waiver</p>
            <p className="text-[0.8125rem] text-white/40 mt-4">Half of remaining monthly fees waived</p>
          </div>
          <div className="reveal-scale d3 rounded-2xl border border-white/10 bg-white/[0.03] p-10 text-center border-glow">
            <p className="font-mono text-[0.6875rem] text-white/55 tracking-[0.12em] uppercase mb-3">Financial Support</p>
            <p className="count-up text-[2.75rem] font-bold text-white tracking-[-0.03em] leading-none mb-2">Open</p>
            <p className="text-[0.9375rem] text-white/65">scholarship</p>
            <p className="text-[0.8125rem] text-white/40 mt-4">Talent should never be limited by finances</p>
          </div>
        </div>
